...
#Evaluate submission
python shifts/translate/assessment/evaluate.py ensemble/test1 ensemble/test3 --beam_width 5 --nbest 5 --ensemble

# Prepare submission
python shifts/translate/assessment/create_submission.py ensemble/test1 ensemble/test3 / --beam_width 5 --nbest 5 --ensemble --uncertainty_metric SCR-PE
